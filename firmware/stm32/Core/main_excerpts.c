/*
 * ISR callbacks and control-loop glue tying the sensor, PD controller,
 * motor driver, and UART bridge together.
 */
...
// ASCII byte-triplet -> float parser (e.g. "025" -> 25.0f)
...
// 50ms PD control cycle, called from the main loop
...
// Forwards the live distance reading to the WiFi module over UART
...
// HC-SR04 echo capture (input-capture interrupt)
...
// UART Rx complete (echoes received bytes back out)
